...
function test {
    ...
    export DISPLAY=:0
    ./com.github.aggalex.ow-author --run-tests
    result=$?
...
"generate-i18n")
    initialize
    ninja com.github.aggalex.ow-author-pot
    ninja com.github.aggalex.ow-author-update-po
    ;;
"install")
    initialize
    sudo ninja install
...
"run")
    initialize
    ./com.github.aggalex.ow-author "${@:2}"
    ;;
"test")
    test
    ;;
